...
class AC2V2Agent(torch.nn.Module):
    ...
    def __init__(self,
        ...
        if self.discrete:
            self.critic.trunk, self.critic.Q_head, self.critic.optim, self.ema = \
                self.actor.trunk, self.actor.Pi_head, self.actor.optim, self.actor.ema
