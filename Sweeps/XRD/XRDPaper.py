...
runs.XRD.sweep = [
    ...
    train_steps=0
    load=true
    save_path='/scratch/slerman/UnifiedML/Checkpoints/No-Pool-CNN/DQNAgent/classify/Large-Soup_${test_dataset.num_classes}-Way_1.pt'
    logger.wandb=true
    num_workers=8
    num_gpus=1
    lab=true
    ...
    train_steps=0
    load=true
    save_path='/scratch/slerman/UnifiedML/Checkpoints/CNN/DQNAgent/classify/Large-Soup_${test_dataset.num_classes}-Way_1.pt'
    logger.wandb=true
    num_workers=8
    num_gpus=1
    lab=true
    ...
    train_steps=0
    load=true
    save_path='/scratch/slerman/UnifiedML/Checkpoints/MLP/DQNAgent/classify/Large-Soup_${test_dataset.num_classes}-Way_1.pt'
    logger.wandb=true
    num_workers=8
    num_gpus=1
    lab=true
    ...
    train_steps=0
    load=true
    save_path='/scratch/slerman/UnifiedML/Checkpoints/No-Pool-CNN/DQNAgent/classify/Mix-Soup_${test_dataset.num_classes}-Way_1.pt'
    logger.wandb=true
    num_workers=8
    num_gpus=1
    lab=true
