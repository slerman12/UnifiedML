...
:white_check_mark: Line graphs for tasks :white_check_mark: Aggregated line graphs per suite :white_check_mark: Bar chart :white_check_mark: Heatmap (confusion matrix) :white_check_mark: Class sizes (scatterplot)
