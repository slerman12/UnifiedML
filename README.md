...
### Mix-And-Matching Architectures
...
One can also pass in custom architectures such as those defined in ```./Blocks/Architectures```.
...
<details>
<summary><i>See more examples, including loading architectures from checkpoints :open_book: </i></summary>
<br>
