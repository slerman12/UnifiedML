...
**Think of them as Pytorch DataLoaders/Datasets but with extra features.** Saving them at the end of training means saving an in-disk buffer e.g. all the data collected during an RL training session.
