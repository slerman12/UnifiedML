...
[comment]: <> (Here's how you can load another saved agent's encoder from an agent checkpoint ```<path>```:)
...
[comment]: <> (You can imagine training a GAN or classifier CNN and then seamlessly using it for RL.)
