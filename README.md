...
You can customize the task name as it's saved for benchmarking and plotting, with ```task_name=```. By default, it will appear as the Dataset class name (in the above examples, ```MNIST``` and ```TinyImageNet```).
