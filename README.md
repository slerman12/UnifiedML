...
* See [Custom Architectures](#custom-architectures) for mix-and-matching custom or pre-defined (*e.g.* ResNet50) or custom architectures via the command line syntax. 
