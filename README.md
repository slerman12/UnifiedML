...
1. Save videos with ```log_video=true```.

2. As of now, all agents are *visual*. 
    * That is, they observe pixel-based inputs.

3. Achieves [top scores](#bar_chart-agents--performances) in data-efficient RL from images across Atari and DMC.
