...
1. As of now, all agents are *visual*, that is, they observe pixel-based inputs.

2. Achieves [top scores](#bar_chart-agents--performances) in data-efficient RL from images across Atari and DMC.
