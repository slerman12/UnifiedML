...
For CUDA 11+ GPU support, you may need to [pip-install Pytorch](https://pytorch.org/get-started/locally/) with your speicifc CUDA version. 

[comment]: <> (from https://pytorch.org/get-started/locally/.)
