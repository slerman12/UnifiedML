...
plt.imshow(np.transpose(vutils.make_grid(obs, padding=5, normalize=True).cpu(), (1, 2, 0)))

plt.subplot(1, 2, 2)
plt.axis('off')
plt.title('Fake Images')
plt.imshow(np.transpose(vutils.make_grid(action, padding=2, normalize=True).cpu(), (1, 2, 0)))
plt.show()
