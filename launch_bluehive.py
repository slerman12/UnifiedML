...
sweep = [
    ...
    'task=classify/custom Dataset=\'Datasets.ReplayBuffer.Classify._RRUFF.RRUFF\' dataset.root=\'../XRDs/xrd_data/05_29_data/\' experiment=\'PS1_noise20_to_RRUFF\' +dataset.data=\'icsd171k_ps1_noise20\' Aug=Blocks.Architectures.Null num_gpus=4 parallel=true logger.wandb=true',
